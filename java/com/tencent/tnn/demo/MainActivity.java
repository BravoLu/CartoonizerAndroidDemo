...
import com.tencent.tnn.demo.ImageCartoonizer.ImageCartoonizerActivity;
import com.tencent.tnn.demo.StreamCartoonizer.StreamCartoonizerActivity;
...
//            }
//        });
        findViewById(R.id.image_cartoonize_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!isShowedActivity) {
                    isShowedActivity = true;
                    Intent intent = new Intent();
                    Activity activity = MainActivity.this;
                    intent.setClass(activity, ImageCartoonizerActivity.class);
                    activity.startActivity(intent);
                }
            }
        });

        findViewById(R.id.stream_cartoonize_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!isShowedActivity) {
                    isShowedActivity = true;
                    Intent intent = new Intent();
                    Activity activity = MainActivity.this;
                    intent.setClass(activity, StreamCartoonizerActivity.class);
                    activity.startActivity(intent);
                }
            }
        });
