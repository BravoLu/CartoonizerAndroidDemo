...
public class ImageCartoonizerActivity extends DemoBaseActivity {
    private static final String TAG = ImageCartoonizerActivity.class.getSimpleName();
    ...
    public void updateUI() {
        Fragment fragment = new ImageCartoonizerFragment();
