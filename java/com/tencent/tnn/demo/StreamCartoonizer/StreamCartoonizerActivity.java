...
public class StreamCartoonizerActivity extends DemoBaseActivity {
    private static final String TAG = StreamCartoonizerActivity.class.getSimpleName();
    ...
    public void updateUI() {
        Fragment fragment = new StreamCartoonizerFragment();
